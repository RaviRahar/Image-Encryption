...
from Cryptodome.Cipher import DES as Ori_DES
from Cryptodome.Random import get_random_bytes


class DES:
    def __init__(self, **kwargs):
        self.key = kwargs["key"] if ("key" in kwargs and len(kwargs["key"]) == 8) else get_random_bytes(8)
        self.model = Ori_DES.new(self.key, Ori_DES.MODE_ECB)
    ...
    def encrypt(self, pimage):         # image as numpy array
        ...
        print("Encryption time for DES: {:.3f}".format(time_ns()-start_time))
